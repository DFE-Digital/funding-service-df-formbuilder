...
suite("uploads", () => {
  ...
  test("request with file upload field populated is successful and redirects to next page", { timeout: 20000 }, async () => {
  ...
  test.skip("request with file upload field containing virus returns with error message", { timeout: 20000 }, async () => {
    restore();
  ...
  test.skip("request with file upload field containing invalid file type returns with error message", { timeout: 20000 }, async () => {
    restore();
    stub(UploadService.prototype, "fileStreamsFromPayload").callsFake(() => {
      return [
        [
