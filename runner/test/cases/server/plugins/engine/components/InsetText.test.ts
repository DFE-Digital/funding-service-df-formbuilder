...
import { InsetText } from "server/plugins/engine/components/InsetText";
...
suite("InsetText", () => {
  describe("Generated schema", () => {
    ...
    const component = new InsetText(componentDefinition, formModel);
