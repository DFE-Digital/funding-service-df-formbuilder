...
describe("inline condition model", () => {
  ...
  describe("complicated conditions", () => {
    ...
    test("should return a human readable presentation string with all properties", () => {
      expect(underTest.toPresentationString()).toEqual(
        "'Badger' is 'Zebras' or ('Under 18' and 'Squiffy' is 'Donkeys') or ('Duration' is at least '10' and 'Squiffy' is not 'Donkeys')"
      );
    });

    test("should return a valid expression", () => {
      expect(underTest.toExpression()).toEqual(
        "badger == 'Zebras' or (under18 and squiffy == 'Donkeys') or (duration >= 10 and squiffy != 'Donkeys')"
      );
    });
  });
  ...
  describe("removing conditions and groups", () => {
    ...
    test("should remove the specified condition indexes", () => {
      underTest.remove([1, 3]);
      expect(underTest.asPerUserGroupings.length).toEqual(3);

      expect(underTest.toPresentationString()).toEqual(
        "'Badger' is 'Zebras' and 'Squiffy' is 'Donkeys' and 'Squiffy' is not 'Donkeys'"
      );
    });

    test("should remove the only conditions", () => {
      underTest.addGroups([new ConditionGroupDef(0, 4)]);
      underTest.remove([0]);
    ...
    test("should remove all elements from a user-defined group", () => {
      ...
      expect(underTest.toPresentationString()).toEqual(
        "'Squiffy' is 'Donkeys' or ('Duration' is at least '10' and 'Squiffy' is not 'Donkeys')"
      );
    });
    ...
    test("should remove all elements from a nested group", () => {
      ...
      expect(underTest.asPerUserGroupings.length).toEqual(3);
      underTest.remove([0]);
      expect(underTest.asPerUserGroupings.length).toEqual(2);

      expect(underTest.toPresentationString()).toEqual(
        "'Duration' is at least '10' and 'Squiffy' is not 'Donkeys'"
      );
    });

    xtest("should do nothing if provided invalid index to remove", () => {
      expect(underTest.asPerUserGroupings.length).toEqual(5);
  ...
  describe("moving conditions and groups", () => {
    ...
    test("should move a condition earlier when not becoming the first item", () => {
      ...
      expect(underTest.toPresentationString()).toEqual(
        "'Badger' is 'Zebras' or 'Under 18' or ('Duration' is at least '10' and 'Squiffy' is 'Donkeys' and 'Squiffy' is not 'Donkeys')"
      );
    });

    test("should move the last condition earlier", () => {
      underTest.moveEarlier(4);

      expect(underTest.toPresentationString()).toEqual(
        "'Badger' is 'Zebras' or ('Under 18' and 'Squiffy' is 'Donkeys' and 'Squiffy' is not 'Donkeys') or 'Duration' is at least '10'"
      );
    });
    ...
    test("should move a condition earlier and switch co-ordinators when becoming the first item", () => {
      ...
      expect(underTest.toPresentationString()).toEqual(
        "'Under 18' or ('Badger' is 'Zebras' and 'Squiffy' is 'Donkeys') or ('Duration' is at least '10' and 'Squiffy' is not 'Donkeys')"
      );
    });
    ...
    test("should move a condition group earlier and switch co-ordinators when becoming the first item", () => {
      ...
      expect(underTest.toPresentationString()).toEqual(
        "('Under 18' and 'Squiffy' is 'Donkeys') or 'Badger' is 'Zebras' or ('Duration' is at least '10' and 'Squiffy' is not 'Donkeys')"
      );
    });
    ...
    test("should move a condition group later and switch co-ordinators when moving the first item", () => {
      ...
      expect(underTest.toPresentationString()).toEqual(
        "('Squiffy' is 'Donkeys' and ('Badger' is 'Zebras' or 'Under 18')) or ('Duration' is at least '10' and 'Squiffy' is not 'Donkeys')"
      );
    });
