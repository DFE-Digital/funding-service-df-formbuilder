...
suite("ComponentCreateList", () => {
  ...
  test("it selects support components on click", () => {
    const wrapper = shallow(
      <ComponentCreateList onSelectComponent={onSelectComponent} />
    );

    const supportComponentsList = wrapper.find("ol").at(1);
    const listItems = supportComponentsList.find("li");
  ...
  test("it input content fields list correctly", () => {
    const wrapper = shallow(
      <ComponentCreateList onSelectComponent={onSelectComponent} />
    );

    const inputComponentsList = wrapper.find("ol").at(3);
    const listItems = inputComponentsList
      .find("li")
      .map((c) => c.find("a").text());
  ...
  test("it displays Selection fields list correctly", () => {
    ...
    const contentComponentsList = wrapper.find("ol").at(4);
