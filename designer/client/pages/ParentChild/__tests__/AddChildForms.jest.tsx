...
describe("Parent & Child Module - Add Child Forms", () => {
    ...
    describe("Render Tests", () => {
        test("Default render", () => {
            ...
            const { container } = renderWithProviders(
                <AddChildForms parentId={"parent1"} />,
                {
                    preloadedState: {
                        parentChild: {
                            loading: LoadingState.Idle,
                            selectedParentForm: sampleFormWithChilds,
            ...
            expect(screen.getByText("Add child form")).toBeInTheDocument();
        });
    });
});
