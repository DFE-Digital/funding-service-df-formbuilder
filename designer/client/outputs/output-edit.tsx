...
class OutputEdit extends Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            ...
            outputTitle: props.output?.title ?? "",
            outputName: props.output?.name ?? "",
            errors: {},
        };
    }
            ...
            case OutputType.Notify:
                outputConfiguration = {
                    ...
                    addReferencesToPersonalisation:
                        formData.get("add-references-to-personalisation") ===
                        "true",
                };
                break;
    ...
    onTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const outputTitle = e.target.value ?? "";
        this.setState({ outputTitle });
    };
    ...
    render() {
        const { outputType, outputTitle, outputName, errors } = this.state;
